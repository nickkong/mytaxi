...
//		refreshingAnimation.setInterpolator(lir);
		...
		translateAnimation.setRepeatCount(10000);//设置重复次数
...
//		refreshingView.setVisibility(View.GONE);
		pullView.clearAnimation();
		ll_box.setVisibility(INVISIBLE);
...
//			loadStateImageView.setBackgroundResource(R.drawable.load_failed);
	...
	private void changeState(int to)
	{
		...
		case RELEASE_TO_REFRESH:
			...
			pullView.startAnimation(translateAnimation);
			break;
		case REFRESHING:
			// 正在刷新状态
//			pullView.clearAnimation();
...
//			pullView.startAnimation(translateAnimation);
		...
		case RELEASE_TO_LOAD:
			...
			pullUpView.startAnimation(translateAnimation);
			break;
		case LOADING:
			// 正在加载状态
//			pullUpView.clearAnimation();
...
//						isTouch = true;
	...
	private void initView()
	{
		...
		ll_box = refreshView.findViewById(R.id.ll_box);
