...
//                    Log.d(TAG, "remainder: " + remainder + ", divided: " + divided);
    ...
    private void initData() {
        ...
        views.removeAllViews(); //先清除全部内容，尤其在联动数据的时候有用
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(getResources().getColor(R.color.TEXT_MAIN));
            } else {
                itemView.setTextColor(getResources().getColor(R.color.TEXT_HINT));
            }
        }
    }
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            paint = new Paint();
            paint.setColor(getResources().getColor(R.color.TEXT_HINT));
